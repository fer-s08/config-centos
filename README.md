...
## Configuracion proyecto final - CentOS
...
Este es un repositorio sencillo que consta únicamente de 4 carpetas
- dhcp: script de configuración del servidor DHCP
- dns: script de configuración del servidor DNS
- lamp: script de configuración del servidor web LAMP
- smtp: script de configuración del servidor de correos SMTP
